...
export default {
    ...
    watch:{
        paperScrollTop: function (val) {
            if (val >= 100) {
                this.titleActive02 = true;
                if (val >= 1000) {
                    this.titleActive03 = true;
                    if (val >= 1800) {
                        this.titleActive04 = true;
                        if (val >= 2200) {
                            this.titleActive05 = true;
                        }
                    }
                }
            }
    ...
    .content_03 {
        ...
        .con{
                ...
                >ul{
                    ...
                    >li{
                        ...
                        >div{
                            ...
                            height:90px;
                            background:rgba(30,163,255,1);
                            box-shadow:0px 15px 36px 0px rgba(30,163,255,0.34);
                            border-radius: 50%;
                            >img{
                                width: 60px;
                                height: 60px;
            ...
            .rigth{
                ...
                box-shadow:0px 23px 23px 0px rgba(30,163,255,0.1);
                border-radius:6px;
                >img{
                    position: absolute;
                    right: 0;
